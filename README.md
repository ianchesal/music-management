...
```bash
pytest tests/                     # Run all Python tests (235 tests)
...
├── test_phish_*.py          # Pytest tests for bin/ tools (235 tests)
